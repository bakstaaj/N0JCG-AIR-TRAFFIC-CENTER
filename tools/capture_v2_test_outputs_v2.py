...
Run from MSYS2 UCRT64 repo root:
  python3 tools/capture_v2_test_outputs_v2.py

Output file:
  C:/Users/jim/Downloads/rtl_windows_v2_test_outputs_YYYYMMDD_HHMMSS.txt

Notes:
  - This script does NOT run the long-running dev launcher.
  - If the dev UI is running, it will capture runtime diagnosis/discovery.
  - If the dev UI is not running, those sections will clearly say FAIL.
"""
...
DOWNLOADS = Path("/c/Users/jim/Downloads")
