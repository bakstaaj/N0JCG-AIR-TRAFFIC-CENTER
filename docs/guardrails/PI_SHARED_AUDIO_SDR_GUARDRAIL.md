...
- Treat `usb_claim_interface error -6`, `Failed to open rtlsdr device`, and `Device or resource busy` during fast-spectrum startup as retryable transient receiver-claim failures.
